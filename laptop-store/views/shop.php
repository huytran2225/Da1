...
<body>
    ...
    <div class="container py-5">
        ...
        <form class="mb-4 text-center" method="GET" action="index.php">
            ...
            <input type="text" name="search" value="<?= htmlspecialchars($_GET['search'] ?? '') ?>" placeholder="Tìm sản phẩm..." class="form-control d-inline w-50">
                ...
                <div class="col-md-3 mb-4">
                    <div class="card h-100 shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <a href="index.php?act=detail&id=<?= $product['id'] ?>" class="btn btn-outline-success w-100">Xem chi tiết</a>
                        </div>
                    </div>
                </div>
            <?php endforeach; ?>
            ...
            <ul class="pagination justify-content-center">
                <?php for ($i = 1; $i <= $totalPages; $i++): ?>
                    <li class="page-item <?= $i == $page ? 'active' : '' ?>">
                        <a class="page-link" href="index.php?act=shop&search=<?= urlencode($search) ?>&page=<?= $i ?>"><?= $i ?></a>
                    </li>
                <?php endfor; ?>
            </ul>
        </nav>
