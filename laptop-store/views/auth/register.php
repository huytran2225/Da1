...
<div class="container mt-5">
  <div class="row justify-content-center">
    <div class="col-md-6">
      ...
      <form method="POST" action="index.php?controller=auth&action=handleRegister" class="card p-4 shadow-sm bg-white">
        ...
        <div class="mb-3">
          ...
          <textarea class="form-control" id="address" name="address"><?= $_SESSION['old_input']['address'] ?? '' ?></textarea>
